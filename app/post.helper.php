...
if (! function_exists('createBlogPosts')) {
    function createBlogPosts()
    {
        ...
        foreach($blog_posts as $blog_post){
            ...
            $newArrayBlog = createBlogPost($blog_post, $user, $typeOfHeader, $header);
            
            array_push($newArrayBlogs, $newArrayBlog);
        }
        return $newArrayBlogs;
    }
}

if (! function_exists('createBlogPost')) {
    function createBlogPost($blog_post, $user, $typeOfHeader, $header)
    {
        $newArrayBlog = new StdClass;
